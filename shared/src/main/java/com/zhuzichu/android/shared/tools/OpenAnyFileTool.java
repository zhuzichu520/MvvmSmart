package com.zhuzichu.android.shared.tools;
...
public class OpenAnyFileTool {
    ...
    private static String getMimeTypeString(File file) {
        String type = "*/*";
...
//        Uri uri = ToolIntent.getUriForFile(context, file);
        Uri uri;
