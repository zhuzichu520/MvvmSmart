object Dep {
    ...
    const val dcendentsVersion = "1.0.0"
    ...
    const val androidxAnnotation =
        "androidx.annotation:annotation:${Version.androidxCore}"

    const val AndroidxExifinterface =
        "androidx.exifinterface:exifinterface:${Version.androidxCore}"

    const val recyclerview =
        "androidx.recyclerview:recyclerview:${Version.androidxCore}"

    const val fastJson = "com.alibaba:fastjson:${Version.fastJson}"

    const val pluginDcendents =
        "com.github.dcendents:android-maven-gradle-plugin:${Version.pluginDcendents}"
