package com.zhuzichu.android.widget.badge;
...
import com.zhuzichu.android.libs.tool.ToolSize;
...
public class QBadgeView extends View implements Badge {
    ...
    private void init() {
        ...
        mBadgeTextSize = ToolSize.dp2px(getContext(), 11);
        mBadgePadding = ToolSize.dp2px(getContext(), 5);
        mBadgeNumber = 0;
        mBadgeGravity = Gravity.END | Gravity.TOP;
        mGravityOffsetX = ToolSize.dp2px(getContext(), 1);
        mGravityOffsetY = ToolSize.dp2px(getContext(), 1);
        mFinalDragDistance = ToolSize.dp2px(getContext(), 90);
        mShowShadow = true;
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                ...
                if (mDraggable && event.getPointerId(event.getActionIndex()) == 0
                    ...
                    mDefalutRadius = ToolSize.dp2px(getContext(), 7);
    ...
    protected Bitmap createBadgeBitmap() {
        Bitmap bitmap = Bitmap.createBitmap((int) mBadgeBackgroundRect.width() + ToolSize.dp2px(getContext(), 3),
                (int) mBadgeBackgroundRect.height() + ToolSize.dp2px(getContext(), 3), Bitmap.Config.ARGB_8888);
    ...
    private void showShadowImpl(boolean showShadow) {
        int x = ToolSize.dp2px(getContext(), 1);
        int y = ToolSize.dp2px(getContext(), 1.5f);
        switch (mDragQuadrant) {
            case 1:
                x = ToolSize.dp2px(getContext(), 1);
                y = ToolSize.dp2px(getContext(), -1.5f);
                break;
            case 2:
                x = ToolSize.dp2px(getContext(), -1);
                y = ToolSize.dp2px(getContext(), -1.5f);
        ...
        mBadgeBackgroundPaint.setShadowLayer(showShadow ? ToolSize.dp2px(getContext(), 2f)
                : 0, x, y, 0x33000000);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBadgeText != null) {
            ...
            if (mDraggable && mDragging) {
                ...
                if (mDragOutOfRange = startCircleRadius < ToolSize.dp2px(getContext(), 1.5f)) {
    ...
    public Badge stroke(int color, float width, boolean isDpValue) {
        ...
        mBackgroundBorderWidth = isDpValue ? ToolSize.dp2px(getContext(), width) : width;
        invalidate();
        return this;
    }
    ...
    public Badge setBadgeTextSize(float size, boolean isSpValue) {
        mBadgeTextSize = isSpValue ? ToolSize.dp2px(getContext(), size) : size;
        measureText();
        invalidate();
        return this;
    }
    ...
    public float getBadgeTextSize(boolean isSpValue) {
        return isSpValue ? ToolSize.px2dp(getContext(), mBadgeTextSize) : mBadgeTextSize;
    }

    @Override
    public Badge setBadgePadding(float padding, boolean isDpValue) {
        mBadgePadding = isDpValue ? ToolSize.dp2px(getContext(), padding) : padding;
        createClipLayer();
        invalidate();
        return this;
    }
    ...
    public float getBadgePadding(boolean isDpValue) {
        return isDpValue ? ToolSize.px2dp(getContext(), mBadgePadding) : mBadgePadding;
    }
    ...
    public Badge setGravityOffset(float offsetX, float offsetY, boolean isDpValue) {
        mGravityOffsetX = isDpValue ? ToolSize.dp2px(getContext(), offsetX) : offsetX;
        mGravityOffsetY = isDpValue ? ToolSize.dp2px(getContext(), offsetY) : offsetY;
        invalidate();
        return this;
    }
    ...
    public float getGravityOffsetX(boolean isDpValue) {
        return isDpValue ? ToolSize.px2dp(getContext(), mGravityOffsetX) : mGravityOffsetX;
    }

    @Override
    public float getGravityOffsetY(boolean isDpValue) {
        return isDpValue ? ToolSize.px2dp(getContext(), mGravityOffsetY) : mGravityOffsetY;
    }
